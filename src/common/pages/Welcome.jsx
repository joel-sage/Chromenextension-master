      ...
      <S.ScrollBar className='w-full h-[90%]'>
        ...
        <div className='h-[90%] w-full text-center relative'>
          ...
          <div className='h-fit w-full absolute bottom-0 flex flex-col justify-center items-center gap-3 '>
            <div onClick={() => navigate("/register")} className="w-[90%] h-fit py-3 px-3 rounded-md space-x-4 text-md font-semibold tracking-wider text-white bg-[#03f38f] cursor-pointer">
              CREATE WALLET
            </div>
            <div className="w-[90%] h-fit py-3 px-3 rounded-md space-x-4 text-md font-semibold tracking-wider text-white bg-[#2008fa] cursor-pointer">
              IMPORT WALLET
            </div>
          </div>
        </div>
